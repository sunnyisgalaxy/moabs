  ...
  namespace io {
    ...
    public:
      ...
      void write_sample_names(stan::mcmc::sample& sample,
        ...
        //dsun: prints:lp__,accept_stat__,stepsize__,treedepth__,n_leapfrog__,n_divergent__,mux,ssx,probx.1,probx.2
      ...
      void write_sample_params(RNG& rng, 
        ...
        for (int i = 0; i < model_values.size(); ++i)
        {
          ...
          //std::cout << "xdsun = " << model_values(i) << std::endl;
        }
        //mdsun: this is where the rows of model values are saved to csv.
      ...
      void write_adapt_finish(stan::mcmc::base_mcmc* sampler, 
        ...
        //mdsun: remove the output csv header
